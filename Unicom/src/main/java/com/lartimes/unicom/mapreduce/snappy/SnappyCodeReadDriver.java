...
public class SnappyCodeReadDriver extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        Job job = Job.getInstance(getConf(), SnappyCodeReadDriver.class.getSimpleName());
        job.setJarByClass(SnappyCodeReadDriver.class);
...
*/
        int status = ToolRunner.run(conf, new SnappyCodeReadDriver(), args);
        System.exit(status);
    }
